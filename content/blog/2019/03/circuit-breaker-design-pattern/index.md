...
- [Factory Design Pattern](@/blog/2022/12/factory-design-pattern/index.md) - Understanding the Factory Pattern
- [Better Software Architect](@/blog/2022/03/better-software-architect/index.md) - Improving software architecture skills
- [Production Readiness Checklist](@/blog/2024/08/production-readiness-checklist/index.md) - Preparing code for production
- [Finding Root Cause Analysis](@/blog/2022/12/finding-rca-of-an-issue/index.md) - Techniques for problem investigation
- [Code Refactoring](@/blog/2020/11/code-refactoring/index.md) - Guide to effective code refactoring