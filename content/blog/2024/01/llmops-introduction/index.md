...
- [The Hidden Cost of LLM-as-a-Judge](@/blog/2025/05/llm-evals/index.md) - Understanding LLM evaluation strategies and best practices
- [Large Language Models History](@/blog/2023/09/large-language-models-history/index.md) - Evolution of language models from rule-based to LLMs
- [ChatGPT Alternatives](@/blog/2023/02/chatgpt-alternatives/index.md) - Explore different LLM options and their capabilities
- [From Naive to Light: The Evolution of RAG Systems](@/blog/2025/04/evolution-rag/index.md) - Understanding Retrieval Augmented Generation in LLMs
- [ML in Academics vs ML in Production](@/blog/2022/10/ml-academics-vs-ml-production/index.md) - Comparing ML deployment strategies
