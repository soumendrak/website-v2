...
- [Code Refactoring](@/blog/2020/11/code-refactoring.md) - Best practices for clean code
- [Finding Root Cause Analysis](@/blog/2022/12/finding-rca-of-an-issue.md) - Problem investigation
- [DevOps and Related Ops](@/blog/2024/04/comparing-devops-dataops-aiops-mlops-and-llmops-key-differences.md) - Understanding Ops practices
- [Circuit Breaker Pattern](@/blog/2019/03/circuit-breaker-design-pattern.md) - Resilient system design
