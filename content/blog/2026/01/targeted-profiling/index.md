...
[extra]
social_media_card = "targeted-profiling-cover.webp"
+++

![Targeted Profiling with tprof](targeted-profiling-cover.webp)
...
- [Creating Python Packages Using Rust](@/blog/2025/03/creating-python-packages-using-rust/index.md)
- [Patching a memory leak](@/blog/2024/05/patching-a-memory-leak/index.md)
